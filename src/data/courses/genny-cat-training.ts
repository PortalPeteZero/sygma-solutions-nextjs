...
export const courseData: CoursePageData = {
  slug: 'genny-cat-training',

  metadata: {
    title: 'CAT and Genny Training Course | EUSR | Sygma Solutions',
    description: 'CAT and Genny training courses delivered UK-wide by the UK\'s only independent specialist. Cable avoidance training. HSG47 compliant. Contact us for pricing.',
  ...
  schemas: {
    course: {
      name: 'CAT and Genny Training Course',
      description: 'CAT and Genny training that changes how your team works on site. Delivered by the UK\'s only independent specialist in underground utility location and avoidance.',
      url: '/courses/genny-cat-training',
      credential: 'CAT and Genny Training Certificate',
      duration: '1 day',
      mode: ['onsite'],
    },
    breadcrumbs: [
  ...
  about: {
    ...
    title: 'The Problem with Standard CAT and Genny Training',
    paragraphs: [
    ...
    sidebar: {
      ...
      items: [
        ...
        {
          label: 'Location',
          value: 'Delivered at your site nationwide | Wigan HQ available as alternative',
        },
        {
          label: 'Max Delegates',
          value: '8 (all formats)',
        ...
        {
          label: 'Assessment',
          value: 'Written MCQ (70% pass) + practical assessment on site',
        },
        {
          label: 'Certificate',
          value: 'Certificate of completion with written and practical results',
        },
        {
          label: 'Equipment',
          value: 'Each operative should use their own site equipment. Sygma provide Radiodetection CAT4 and Genny4 as backup. Any manufacturer\'s locator and signal generator is suitable.',
        },
        {
          label: 'CITB',
  ...
  formats: {
    ...
    rows: [
      ...
      {
        format: 'One-day ProQual CAT1 (accredited)',
        duration: '1 day',
        maxDelegates: '8',
        assessment: 'Written + practical',
      },
      {
        format: 'Two-day in-house (certified)',
        duration: '2 days',
        maxDelegates: '8',
        assessment: 'Written + practical',
      },
      {
        format: 'Two-day ProQual CAT1 Plus (accredited)',
        duration: '2 days',
        maxDelegates: '8',
        assessment: 'Written + practical',
      },
      {
        format: 'Two-day split -- 3 months apart (certified)',
        duration: 'Day 1 + Day 2',
        maxDelegates: '8',
        assessment: 'Day 1 training, Day 2 assessment',
      },
    ],
  },
  ...
  certRoutes: {
    ...
    title: 'Cat and Genny Certificate and Qualification Routes',
    intro: 'On successful completion of your cat and genny training, the certification you receive depends on the course format chosen. All routes include written and practical assessment, and all are delivered to the same Sygma standard. The difference is in the awarding body and the type of ID card or certificate issued.',
    items: [
      {
  ...
  photoStrips: [
    {
      ...
      images: [
        {
          src: 'CAT4-and-Genny-79.jpg',
          alt: 'Genny & CAT training on a live utility site',
        },
      ],
    },
    {
      ...
      images: [
        {
          src: 'CAT4-and-Genny-41.webp',
          alt: 'Genny4 signal generator practical training',
        },
        {
          src: 'CAT4-and-Genny-51.webp',
          alt: 'Genny & CAT training assessment on buried services',
        },
        {
          src: 'CAT4-and-Genny-63.webp',
          alt: 'Hands-on Genny signal application demonstration',
        },
      ],
    },
  ],
