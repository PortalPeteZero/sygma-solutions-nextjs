      ...
      <section className="container mx-auto px-6 md:px-8 py-14 max-w-5xl">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <div className="bg-background rounded-xl border border-border p-6">
            <Image src="Utility-Mapping-02" width={600} height={400} alt="Surveyors and Technicians" sizes="(max-width: 768px) 100vw, 33vw" className="w-full rounded-lg object-cover aspect-[4/3] mb-4" />
          ...
          <div className="bg-background rounded-xl border border-border p-6">
            <Image src="MALA-GPR-15" width={600} height={400} alt="Senior Practitioners and Survey Managers" sizes="(max-width: 768px) 100vw, 33vw" className="w-full rounded-lg object-cover aspect-[4/3] mb-4" />
          ...
          <div className="bg-background rounded-xl border border-border p-6">
            <Image src="Advanced-EM-04" width={600} height={400} alt="Project Managers and Service Coordinators" sizes="(max-width: 768px) 100vw, 33vw" className="w-full rounded-lg object-cover aspect-[4/3] mb-4" />
      ...
      <section className="container mx-auto px-6 md:px-8 py-14 max-w-5xl">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <Link href="/courses/gpr-training" className="group bg-background rounded-xl border border-border p-6 hover:border-primary/40 hover:shadow-sm transition-all">
            <Image src="MALA-GPR-11" width={600} height={400} alt="GPR Training: MALA and Leica Systems" sizes="(max-width: 768px) 100vw, 33vw" className="w-full rounded-lg object-cover aspect-[4/3] mb-4" />
          ...
          <Link href="/courses/5-day-pas128-surveyor" className="group bg-background rounded-xl border border-border p-6 hover:border-primary/40 hover:shadow-sm transition-all">
            <Image src="Utility-Mapping-04" width={600} height={400} alt="5-Day PAS128 Surveyor Course" sizes="(max-width: 768px) 100vw, 33vw" className="w-full rounded-lg object-cover aspect-[4/3] mb-4" />
          ...
          <Link href="/courses/pas128-awareness" className="group bg-background rounded-xl border border-border p-6 hover:border-primary/40 hover:shadow-sm transition-all">
            <Image src="CAT4-and-Genny-03" width={600} height={400} alt="PAS128 Awareness: Service Coordinators" sizes="(max-width: 768px) 100vw, 33vw" className="w-full rounded-lg object-cover aspect-[4/3] mb-4" />
