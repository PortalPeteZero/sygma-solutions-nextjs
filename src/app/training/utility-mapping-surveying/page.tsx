        ...
        <div className="grid md:grid-cols-3 gap-6">
          <div className="bg-background rounded-xl border border-border p-6">
            <div className="aspect-[4/3] bg-muted rounded-lg overflow-hidden">
              <Image src="gpr-07" width={600} height={400} alt="Surveyors and Technicians" sizes="(max-width: 768px) 100vw, 33vw" className="w-full h-full object-contain rounded-lg mb-4" />
            </div>
          ...
          <div className="bg-background rounded-xl border border-border p-6">
            <div className="aspect-[4/3] bg-muted rounded-lg overflow-hidden">
              <Image src="gpr-05" width={600} height={400} alt="Senior Practitioners and Survey Managers" sizes="(max-width: 768px) 100vw, 33vw" className="w-full h-full object-contain rounded-lg mb-4" />
            </div>
          ...
          <div className="bg-background rounded-xl border border-border p-6">
            <div className="aspect-[4/3] bg-muted rounded-lg overflow-hidden">
              <Image src="gpr-12" width={600} height={400} alt="Project Managers and Service Coordinators" sizes="(max-width: 768px) 100vw, 33vw" className="w-full h-full object-contain rounded-lg mb-4" />
            </div>
      ...
      <section className="container mx-auto px-6 md:px-8 py-14 max-w-5xl">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <Link href="/courses/gpr-training" className="group bg-background rounded-xl border border-border p-6 hover:border-primary/40 hover:shadow-sm transition-all">
            <div className="aspect-[4/3] bg-muted rounded-lg overflow-hidden">
              <Image src="gpr-04" width={600} height={400} alt="GPR Training: MALA and Leica Systems" sizes="(max-width: 768px) 100vw, 33vw" className="w-full h-full object-contain rounded-lg mb-4" />
            </div>
          ...
          <Link href="/courses/5-day-pas128-surveyor" className="group bg-background rounded-xl border border-border p-6 hover:border-primary/40 hover:shadow-sm transition-all">
            <div className="aspect-[4/3] bg-muted rounded-lg overflow-hidden">
              <Image src="gpr-01" width={600} height={400} alt="5-Day PAS128 Surveyor Course" sizes="(max-width: 768px) 100vw, 33vw" className="w-full h-full object-contain rounded-lg mb-4" />
            </div>
          ...
          <Link href="/courses/pas128-awareness" className="group bg-background rounded-xl border border-border p-6 hover:border-primary/40 hover:shadow-sm transition-all">
            <div className="aspect-[4/3] bg-muted rounded-lg overflow-hidden">
              <Image src="gpr-11" width={600} height={400} alt="PAS128 Awareness: Service Coordinators" sizes="(max-width: 768px) 100vw, 33vw" className="w-full h-full object-contain rounded-lg mb-4" />
            </div>
