    ...
    <>
      ...
      <section className="container mx-auto px-6 md:px-8 py-14 max-w-5xl">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          <div className="bg-background rounded-xl border border-border p-6">
            <Image src="MALA-GPR-07" width={600} height={400} alt="Senior Practitioners and Survey Managers" sizes="(max-width: 768px) 100vw, 33vw" className="w-full rounded-lg object-cover aspect-[4/3] mb-4" />
          ...
          <div className="bg-background rounded-xl border border-border p-6">
            <Image src="Advanced-EM-08" width={600} height={400} alt="Project Managers and Service Coordinators" sizes="(max-width: 768px) 100vw, 33vw" className="w-full rounded-lg object-cover aspect-[4/3] mb-4" />
      ...
      <section className="container mx-auto px-6 md:px-8 py-14 max-w-5xl">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <Link href="/courses/gpr-training" className="group bg-background rounded-xl border border-border p-6 hover:border-primary/40 hover:shadow-sm transition-all">
            <Image src="MALA-GPR-05" width={600} height={400} alt="GPR Training: MALA and Leica Systems" sizes="(max-width: 768px) 100vw, 33vw" className="w-full rounded-lg object-cover aspect-[4/3] mb-4" />
