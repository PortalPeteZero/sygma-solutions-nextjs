      ...
      <section className="py-16 bg-background">
        <div className="container mx-auto px-6 md:px-8 max-w-5xl">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <Image src="cat-70" width={1200} height={900} alt="Sygma Solutions specialist trainer demonstrating advanced EM equipment" sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" className="w-full rounded-lg aspect-[4/5]" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-background">
        <div className="container mx-auto px-6 md:px-8 max-w-5xl">
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
            <Image src="cat-71" width={1200} height={900} alt="Specialist trainer demonstrating Genny & CAT equipment to operatives" sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" className="w-full rounded-lg" />
            <Image src="cat-72" width={1200} height={900} alt="Genny & CAT specialist training session with field operatives" sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" className="w-full rounded-lg" />
            <Image src="cat-73" width={1200} height={900} alt="Hands-on Genny & CAT practical training demonstration" sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" className="w-full rounded-lg" />
            <Image src="cat-74" width={1200} height={900} alt="Operative using CAT locator during utility location training" sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" className="w-full rounded-lg" />
            <Image src="cat-75" width={1200} height={900} alt="Genny signal source being connected during underground utility training" sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" className="w-full rounded-lg" />
            <Image src="cat-76" width={1200} height={900} alt="Field training session for cable avoidance operatives" sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" className="w-full rounded-lg" />
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-muted/30">
        <div className="container mx-auto px-6 md:px-8 max-w-5xl">
          <div className="grid md:grid-cols-2 gap-12 items-start mb-12">
            ...
            <div>
              <Image src="cat-77" width={1200} height={900} alt="Sygma trainer explaining electromagnetic signal behaviour to operatives" sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" className="w-full rounded-lg" />
            </div>
          </div>
      ...
      <section className="py-16 bg-muted/30">
        <div className="container mx-auto px-6 md:px-8 max-w-5xl">
          <div className="grid md:grid-cols-2 gap-12 items-start mb-12">
            ...
            <div>
              <Image src="cat-78" width={1200} height={900} alt="Sygma directly employed specialist trainer conducting utility training" sizes="(max-width: 768px) 100vw, 50vw" className="w-full rounded-lg" />
            </div>
          </div>
          <div className="grid md:grid-cols-2 gap-4">
            {[
