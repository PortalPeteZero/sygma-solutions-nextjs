...
export const metadata: Metadata = {
  title: 'CAT and Genny Training Birmingham | EUSR CAT 1',
  description: 'CAT and Genny training in Birmingham and the Midlands. On-site CAT4 and Genny equipment courses. EUSR CAT 1 and ProQual accredited. CITB ATO.',
  alternates: { canonical: 'https://sygma-solutions.com/cat-and-genny-training-birmingham' },
  openGraph: {
    title: 'CAT and Genny Training Birmingham | EUSR CAT 1',
    description: 'CAT and Genny training in Birmingham and the Midlands. On-site CAT4 and Genny equipment courses. EUSR CAT 1 and ProQual accredited. CITB ATO.',
    url: 'https://sygma-solutions.com/cat-and-genny-training-birmingham',
    siteName: SITE_NAME,
...
export default function CatAndGennyTrainingBirmingham() {
  const faqs = [
    { q: 'What does a CAT and Genny course in Birmingham cover?', a: 'Your operatives learn to operate the CAT4 cable avoidance tool and the Genny signal generator competently: the four CAT locating modes, applying a Genny signal to a target line, reading depth and signal, and the EUSR Category 1 standard for locating buried services. Classroom theory is paired with practical instruction on your own Midlands site.' },
    { q: 'Do you deliver CAT and Genny training across the Midlands?', a: 'Yes. Sygma delivers on site across Birmingham, the wider West Midlands, Coventry, Wolverhampton, the Black Country and along the M5, M6 and M42 corridors. Your team trains on the buried services already in the ground at your depot or project, not at a centre miles away.' },
    { q: 'Do you bring the CAT4 and Genny equipment?', a: 'Yes. Our trainers bring the CAT4 tools, Genny signal generators and all assessment materials to your Midlands site, and your team can also train on their own kit so they finish confident with the equipment they use daily.' },
    { q: 'What qualification do operatives receive?', a: 'One CAT and Genny programme leads to several routes: a Sygma in-house certificate the same day, the <a href=/courses/eusr-cat1>EUSR Category 1</a> card, or the externally verified <a href=/courses/proqualcat1-training>ProQual CAT1</a> qualification. We help you choose the route your clients and frameworks require.' },
    { q: 'Is CITB funding available for CAT and Genny training in Birmingham?', a: 'Sygma Solutions is a CITB Approved Training Organisation. CITB-registered Midlands businesses may be able to access funding towards CAT and Genny course costs through the CITB Employer Network model.' },
  ];

  return (
    <>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: courseSchema({ name: 'CAT and Genny Training Birmingham', description: 'On-site CAT and Genny equipment training (CAT4 and Genny) across Birmingham and the Midlands. EUSR CAT 1 and ProQual accredited, CITB Approved Training Organisation.', url: '/cat-and-genny-training-birmingham', duration: '1 day', mode: ['onsite'] }) }} />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: faqPageSchema(faqs) }} />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: breadcrumbSchema([{ label: "All Courses", to: "/courses" }, { label: "CAT and Genny Training Birmingham" }]) }} />

      {/* Hero */}
      <div className="relative w-full overflow-hidden bg-foreground">
        <Image src="cat-06" alt="CAT and Genny training in Birmingham" fill className="absolute inset-0 object-contain" priority />
        ...
        <div className="relative flex flex-col justify-end p-8 md:p-12 h-full">
          ...
          <h1 className="text-4xl md:text-5xl font-black tracking-tight text-primary-foreground mb-3">CAT and Genny Training Birmingham | Midlands On-Site Specialists</h1>
          <p className="text-lg text-primary-foreground/80 max-w-3xl">Sygma Solutions delivers CAT and Genny training across Birmingham and the Midlands, on your site, on the CAT4 cable avoidance tool and Genny signal generator your operatives use every day. EUSR and ProQual accredited, a CITB Approved Training Organisation, 21 years in underground utility location. We travel to you, with no travel surcharge.</p>
      ...
      <section className="container mx-auto px-6 md:px-8 py-14 max-w-5xl">
        ...
        <h2 className="text-2xl md:text-3xl font-black mb-6 text-foreground">CAT and Genny Courses We Deliver in Birmingham</h2>
        <p className="text-muted-foreground mb-8 max-w-3xl leading-relaxed">Each course is a private, in-house session at your Midlands premises with hands-on practical training on genuine CAT4 and Genny equipment. You choose the date; we bring the tools, signal generators and assessors. Every route certifies operatives to locate buried utilities before excavation.</p>
      ...
      <div className="grid grid-cols-3 gap-3">
        <div className="overflow-hidden rounded-lg aspect-[4/3] bg-muted"><Image src="cat-01" width={1200} height={900} alt="CAT4 cable avoidance tool in use on a Birmingham site" sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" className="w-full h-full object-contain hover:scale-105 transition-transform duration-500" /></div>
        <div className="overflow-hidden rounded-lg aspect-[4/3] bg-muted"><Image src="cat-08" width={1200} height={900} alt="Genny signal generator during CAT and Genny training in the Midlands" sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" className="w-full h-full object-contain hover:scale-105 transition-transform duration-500" /></div>
        <div className="overflow-hidden rounded-lg aspect-[4/3] bg-muted"><Image src="cat-12" width={1200} height={900} alt="Practical CAT and Genny equipment training in Birmingham" sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" className="w-full h-full object-contain hover:scale-105 transition-transform duration-500" /></div>
      </div>

      {/* Image break */}
      <div className="w-full overflow-hidden bg-muted" style={{ aspectRatio: "1600 / 733" }}>
        <Image src="cat-55" width={1600} height={733} alt="CAT and Genny equipment training in the Midlands" sizes="100vw" className="w-full h-full object-cover" />
      </div>
      ...
      {/* Why on-site Birmingham */}
      <section className="bg-muted/30 py-14">
        <div className="container mx-auto px-6 md:px-8 max-w-5xl">
          <p className="eyebrow text-primary mb-3">On-Site Delivery</p>
          <h2 className="text-2xl md:text-3xl font-black mb-8 text-foreground">Why Midlands Teams Choose On-Site CAT and Genny Training</h2>
          <div className="space-y-4 text-muted-foreground leading-relaxed max-w-3xl">
            <p>The Midlands is one of the busiest groundworks regions in the UK. HS2, the motorway network around Spaghetti Junction, ongoing city-centre regeneration in Birmingham and heavy logistics and manufacturing infrastructure across the Black Country mean operatives are constantly working near buried services. Competent CAT4 and Genny operation is what keeps those crews — and the networks beneath them — safe.</p>
            <p>Training on your own Midlands site means your team learns the equipment against the services and ground conditions they actually work in, not a demonstration field. That is the difference between a classroom pass and a confident operator on a live dig.</p>
            <p>We deliver across Birmingham, Coventry, Wolverhampton, the Black Country and the wider West Midlands, half day or full day, with travel included.</p>
          </div>
        </div>
      </section>
      ...
      <section className="container mx-auto px-6 md:px-8 py-14 max-w-5xl">
        ...
        <h2 className="text-2xl md:text-3xl font-black mb-6 text-foreground">CITB Funding for CAT and Genny Training in Birmingham</h2>
        <div className="space-y-4 text-muted-foreground leading-relaxed max-w-3xl">
          <p>Sygma Solutions is a CITB Approved Training Organisation. Midlands construction businesses registered with CITB may be able to access funding support towards eligible CAT and Genny course costs through the CITB Employer Network model. Ask your adviser, or contact Sygma and we will help you through it.</p>
        </div>
      </section>
      ...
      <section className="bg-primary border-y border-border py-14">
        <div className="container mx-auto px-6 text-center">
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            <Link href="/contact" className="inline-flex items-center px-6 py-3 rounded-md bg-primary-foreground text-primary font-bold text-sm hover:bg-primary-foreground/90 transition-colors">Get a Birmingham CAT and Genny Quote</Link>
