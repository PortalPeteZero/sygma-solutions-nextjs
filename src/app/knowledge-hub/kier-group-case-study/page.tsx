...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: 'article',
    images: [cloudinaryOgImage('cat-11-kier-group-case-study', 'Kier Group bespoke utility avoidance refresher training')],
  },
};
...
export default function KierGroupCaseStudy() {
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: articleSchema({
            ...
            image: 'cat-70-kier-group-case-study',
          }),
        }}
      />
      <script
      ...
      <InnerPageHero
        image="cat-89-kier-group-case-study"
          ...
          <article className="min-w-0 flex-1 max-w-3xl">
            ...
            <div className="grid grid-cols-3 gap-1 rounded-lg overflow-hidden my-10">
              <div className="overflow-hidden aspect-[4/3] bg-muted">
                <Image src="cat-66-kier-group-case-study" width={1200} height={900} alt="Bespoke utility avoidance training for Kier Group" sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" className="w-full h-full object-contain hover:scale-105 transition-transform duration-500" />
              </div>
              <div className="overflow-hidden aspect-[4/3] bg-muted">
                <Image src="cat-14-kier-group-case-study" width={1200} height={900} alt="CAT and Genny practical assessment session" sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" className="w-full h-full object-contain hover:scale-105 transition-transform duration-500" />
              </div>
              <div className="overflow-hidden aspect-[4/3] bg-muted">
