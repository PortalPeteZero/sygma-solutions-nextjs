...
const faqs = [
  {
    ...
    a: "No. EUS CAT1 includes a mandatory practical assessment that must be completed in person. There is no online-only renewal option.",
  },
  {
    q: "Is the renewal course shorter than the original?",
    a: "No. The renewal is a full one-day course. EUS does not offer a shortened refresher. This is because the scheme requires demonstration of current competency, not just attendance.",
  },
  {
    q: "What if I hold both EUS and ProQual accreditations?",
  ...
  },
  {
    ...
    a: "No. If you have never held an EUS accreditation, you are a new candidate rather than a renewal. The course is the same, but you will not have an existing record on the EUSR register.",
  },
];
  ...
  return (
    <>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: articleSchema({
        headline: "How to Renew Your EUSR Card: A Complete Guide to EUS Card Renewal",
        description: "Your EUSR card has expired or is about to expire. This guide explains the EUS card renewal process, what happens if your card lapses, and how to rebook your training.",
      ...
      <InnerPageHero
        ...
        sub="Your EUS card is expiring or has already lapsed. Here is what you need to do, what the process involves, and how long it takes."
        breadcrumbs={[
          { label: "Knowledge Hub", to: "/knowledge-hub" },
          { label: "EUSR Card Renewal" },
        ]}
      ...
      <div className="bg-background py-16">
        <div className="container mx-auto px-6 md:px-8 flex gap-12 items-start">
          ...
          <h2 className="text-2xl font-black text-foreground mb-4 mt-10">How Long Does an EUS Card Last?</h2>
          ...
          <div className="grid grid-cols-3 gap-1 rounded-lg overflow-hidden my-10">
            <div className="overflow-hidden aspect-[4/3]">
              <Image src="CAT4-and-Genny-43" width={1200} height={800} alt="EUSR training and practical assessment" sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" className="h-full w-full object-cover hover:scale-105 transition-transform duration-500" />
            </div>
            <div className="overflow-hidden aspect-[4/3]">
              <Image src="CAT4-and-Genny-59" width={1200} height={800} alt="Cable locating equipment training session" sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" className="h-full w-full object-cover hover:scale-105 transition-transform duration-500" />
            </div>
            <div className="overflow-hidden aspect-[4/3]">
              <Image src="Safe-Dig-05" width={1200} height={800} alt="Safe digging practices during renewal training" sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" className="h-full w-full object-cover hover:scale-105 transition-transform duration-500" />
            </div>
          </div>
          ...
          <h2 className="text-2xl font-black text-foreground mb-4 mt-10">The EUS Card Renewal Process</h2>
          ...
          <h2 className="text-2xl font-black text-foreground mb-4 mt-10">How to Book Your EUS Renewal</h2>
          ...
          <div className="grid grid-cols-3 gap-1 rounded-lg overflow-hidden my-10">
            <div className="overflow-hidden aspect-[4/3]">
              <Image src="CAT4-and-Genny-41" width={1200} height={800} alt="Practical hands-on renewal training session" sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" className="h-full w-full object-cover hover:scale-105 transition-transform duration-500" />
            </div>
            <div className="overflow-hidden aspect-[4/3]">
              <Image src="CAT4-and-Genny-53" width={1200} height={800} alt="EUSR card renewal assessment" sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" className="h-full w-full object-cover hover:scale-105 transition-transform duration-500" />
            </div>
            <div className="overflow-hidden aspect-[4/3]">
              <Image src="Safe-Dig-17" width={1200} height={800} alt="Delegates during final renewal assessment" sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" className="h-full w-full object-cover hover:scale-105 transition-transform duration-500" />
            </div>
          </div>
          ...
          <p className="text-muted-foreground leading-relaxed mb-6">
            Yes. Many operatives use their renewal as an opportunity to progress. Instead of simply rebooking EUS CAT1, you could consider completing <Link href="/courses/proqualcat1-training" className="text-primary hover:underline">ProQual CAT1</Link>, which is an externally verified, ProQual-accredited qualification that also satisfies most client requirements. Alternatively, you could book <Link href="/courses/eus-cat2-safe-dig" className="text-primary hover:underline">EUS CAT2 Safe Dig</Link> to add excavation competency to your profile, or speak to your employer about <Link href="/osca" className="text-primary hover:underline">OSCA (On-Site Competency Assessment)</Link> to demonstrate your skills in a real working environment.
          </p>
