...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: 'article',
    images: [cloudinaryOgImage('cat-74-utility-strikes-first-20-metres', 'Utility strike prevention')],
  },
};
...
export default function UtilityStrikesFirst20Metres() {
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: articleSchema({
            ...
            image: 'cat-11-utility-strikes-first-20-metres',
          }),
        }}
      />
      <script
      ...
      <InnerPageHero
        image="cat-70-utility-strikes-first-20-metres"
          ...
          <article className="min-w-0 flex-1 max-w-3xl">
            ...
            <div className="grid grid-cols-3 gap-1 rounded-lg overflow-hidden my-10">
              <div className="overflow-hidden aspect-[4/3] bg-muted">
                <Image src="cat-89-utility-strikes-first-20-metres" width={1200} height={900} alt="Excavation near buried utility services" sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" className="w-full h-full object-contain hover:scale-105 transition-transform duration-500" />
              </div>
              <div className="overflow-hidden aspect-[4/3] bg-muted">
                <Image src="cat-66-utility-strikes-first-20-metres" width={1200} height={900} alt="Cable detection equipment in use on site" sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" className="w-full h-full object-contain hover:scale-105 transition-transform duration-500" />
              </div>
              <div className="overflow-hidden aspect-[4/3] bg-muted">
                <Image src="cat-14-utility-strikes-first-20-metres" width={1200} height={900} alt="Safe digging practices on construction site" sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" className="w-full h-full object-contain hover:scale-105 transition-transform duration-500" />
              </div>
            </div>
            ...
            <div className="grid grid-cols-3 gap-1 rounded-lg overflow-hidden my-10">
              <div className="overflow-hidden aspect-[4/3] bg-muted">
                <Image src="cat-77-utility-strikes-first-20-metres" width={1200} height={900} alt="Utility avoidance training practical session" sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" className="w-full h-full object-contain hover:scale-105 transition-transform duration-500" />
              </div>
              <div className="overflow-hidden aspect-[4/3] bg-muted">
                <Image src="cat-09-utility-strikes-first-20-metres" width={1200} height={900} alt="Hand tools used for safe excavation near services" sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" className="w-full h-full object-contain hover:scale-105 transition-transform duration-500" />
              </div>
              <div className="overflow-hidden aspect-[4/3] bg-muted">
                <Image src="cat-90-utility-strikes-first-20-metres" width={1200} height={900} alt="Team completing cable avoidance training" sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" className="w-full h-full object-contain hover:scale-105 transition-transform duration-500" />
              </div>
            </div>
