...
export default function CableAvoidanceBirmingham() {
  ...
  return (
    <>
      ...
      {/* Image Break */}
      <div className="w-full overflow-hidden aspect-[21/9] bg-muted"><Image src="cat-92-cable-avoidance-training-birmingham" width={1200} height={900} alt="Utility avoidance training site conditions" sizes="100vw" className="w-full h-full object-contain" /></div>
