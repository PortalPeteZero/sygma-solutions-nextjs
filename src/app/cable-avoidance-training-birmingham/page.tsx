...
export const metadata: Metadata = {
  title: 'Cable Avoidance Training Birmingham | Utility Mapping',
  description: 'Professional cable avoidance training in Birmingham. Learn to identify and avoid underground utilities safely.',
  keywords: 'cable avoidance, Birmingham, utility training, underground cables, safe digging',
  openGraph: {
    title: 'Cable Avoidance Training Birmingham',
    description: 'Professional cable avoidance training in Birmingham',
    type: 'website',
  },
};
...
export default function CableAvoidanceTrainingBirmingham() {
  return (
    <main>
      <script
        type="application/ld+json"
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(faqPageSchema(faqs, 'Cable Avoidance Training Birmingham')),
        }}
      />
      <script
        type="application/ld+json"
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(
            breadcrumbSchema([
              ...
              { name: 'Cable Avoidance Training Birmingham', url: '/cable-avoidance-training-birmingham' },
            ])
          ),
        }}
      />
      ...
      <div className="hero-section">
        <h1>Cable Avoidance Training in Birmingham</h1>
      ...
      <section className="image-strip">
        <Image
          src="/images/birmingham-training-1.jpg"
