...
const pathways = [
  ...
  { title: 'Professional Utility Mapping', desc: 'PAS 128 Surveyor training, GPR, RQF and ProQual qualifications from Level 2 Award to Level 6 Diploma.', cta: 'View Courses', href: '/training/utility-mapping-surveying', image: 'cat-01' },
        ...
        <div className="container mx-auto px-6 md:px-8 max-w-5xl">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="rounded-xl overflow-hidden border border-border aspect-[4/3] bg-muted">
              <Image src="cat-64" width={1200} height={900} alt="Genny & CAT training" sizes="(max-width: 768px) 100vw, 50vw" className="w-full h-full object-contain" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-muted/30">
        <div className="container mx-auto px-6 md:px-8">
          <div className="grid md:grid-cols-2 gap-12 items-center max-w-5xl mx-auto">
            ...
            <div className="rounded-xl overflow-hidden border border-border aspect-[4/3] bg-muted">
              <Image src="cat-08" width={1200} height={900} alt="On-site utility training with Sygma Solutions" sizes="(max-width: 768px) 100vw, 50vw" className="w-full h-full object-contain" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-muted/30">
        <div className="container mx-auto px-6 md:px-8 max-w-5xl">
          <div className="grid md:grid-cols-2 gap-12 items-start">
            ...
            <div className="rounded-xl overflow-hidden border border-border aspect-[4/3] bg-muted">
              <Image src="cat-80" width={1200} height={900} alt="On-site training delivery across the UK" sizes="(max-width: 768px) 100vw, 50vw" className="w-full h-full object-contain" />
            </div>
          </div>
        </div>
      </section>
