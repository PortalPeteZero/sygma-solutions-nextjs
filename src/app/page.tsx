            ...
            {pathways.map((p) => (
              <div key={p.title} className="relative overflow-hidden rounded-xl border border-border bg-card group">
                <div className="relative aspect-[16/10] overflow-hidden">
                  <Image src={p.image} width={1200} height={750} alt={p.title} sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" className="w-full h-full object-contain transition-transform duration-500 group-hover:scale-105" />
                </div>
                <div className="p-6">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <Link href="/courses/cable-avoidance-training" className="inline-flex items-center px-5 py-2.5 rounded-md border border-primary text-primary font-semibold text-sm hover:bg-primary/10 transition-colors">
                See Our Cable Avoidance Training Course <ArrowRight size={14} className="ml-1.5" />
              </Link>
            </div>
