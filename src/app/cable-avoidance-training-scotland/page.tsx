...
export const metadata: Metadata = {
  title: 'Cable Avoidance Training Scotland | Utility Mapping',
  description: 'Professional cable avoidance training in Scotland. Learn to identify and avoid underground utilities safely.',
  keywords: 'cable avoidance, Scotland, utility training, underground cables, safe digging',
  openGraph: {
    title: 'Cable Avoidance Training Scotland',
    description: 'Professional cable avoidance training in Scotland',
    type: 'website',
  },
};
...
export default function CableAvoidanceTrainingScotland() {
  return (
    <main>
      <script
        type="application/ld+json"
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(faqPageSchema(faqs, 'Cable Avoidance Training Scotland')),
        }}
      />
      <script
        type="application/ld+json"
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(
            breadcrumbSchema([
              ...
              { name: 'Cable Avoidance Training Scotland', url: '/cable-avoidance-training-scotland' },
            ])
          ),
        }}
      />
      ...
      <div className="hero-section">
        <h1>Cable Avoidance Training in Scotland</h1>
      ...
      <section className="image-strip">
        <Image
          src="/images/scotland-training-1.jpg"
