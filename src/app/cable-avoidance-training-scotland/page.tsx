...
export default function CableAvoidanceScotland() {
  ...
  return (
    <>
      ...
      {/* Image Break */}
      <div className="w-full overflow-hidden aspect-[4/3] md:aspect-[16/9] bg-muted"><Image src="cat-52" width={1200} height={900} alt="Utility avoidance training site conditions" sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" className="w-full h-full object-contain" /></div>
