...
export const metadata: Metadata = {
  title: 'Cable Avoidance Training Scotland | CAT and Genny Courses',
  description: 'Cable avoidance training in Scotland. CAT and Genny courses at your site. EUSR, ProQual accredited. CITB ATO.',
...
export default function CableAvoidanceScotland() {
  const faqs = [
  { q: 'Do you deliver cable avoidance training in Scotland?', a: 'Yes. Sygma Solutions delivers cable avoidance and CAT and Genny training at client sites across Scotland including Edinburgh, Glasgow and the Central Belt.' },
  ...
  { q: 'Can you deliver at our site?', a: 'Yes. Sygma delivers at client premises across Scotland including depots, sites, training rooms and open yard space.' },
  ...
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: breadcrumbSchema([{ label: "All Courses", to: "/courses" }, { label: "Cable Avoidance Training Scotland" }]) }} />
      ...
      <div className="relative w-full overflow-hidden bg-foreground">
        ...
        <div className="relative flex flex-col justify-end p-8 md:p-12 h-full">
          ...
          <h1 className="text-4xl md:text-5xl font-black tracking-tight text-primary-foreground mb-3">Cable Avoidance Training Scotland | Nationwide Coverage</h1>
          <p className="text-lg text-primary-foreground/80 max-w-3xl">Sygma Solutions delivers cable avoidance training and practical CAT and Genny equipment instruction at your site across Scotland. With 21 years delivering on capital projects, infrastructure sites and contractor premises nationwide, our specialist trainers come to you.</p>
      ...
      <section className="container mx-auto px-6 md:px-8 py-14 max-w-5xl">
        ...
        <h2 className="text-2xl md:text-3xl font-black mb-6 text-foreground">Courses We Deliver in Scotland</h2>
        <p className="text-muted-foreground mb-8 max-w-3xl leading-relaxed">We deliver cable avoidance training and genny courses at your premises across Scotland including Edinburgh, Glasgow, the Central Belt and beyond. All courses are private, in-house sessions with hands-on practical training using genuine CAT and Genny equipment.</p>
      ...
      <div className="grid grid-cols-3 gap-3">
        <div className="overflow-hidden rounded-lg aspect-[4/3] bg-muted"><Image src="cat-43" width={1200} height={900} alt="Operative scanning with CAT4" sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" className="w-full h-full object-contain hover:scale-105 transition-transform duration-500" /></div>
        <div className="overflow-hidden rounded-lg aspect-[4/3] bg-muted"><Image src="cat-44" width={1200} height={900} alt="Genny signal application during training" sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" className="w-full h-full object-contain hover:scale-105 transition-transform duration-500" /></div>
        <div className="overflow-hidden rounded-lg aspect-[4/3] bg-muted"><Image src="cat-45" width={1200} height={900} alt="CAT and Genny session near underground services" sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" className="w-full h-full object-contain hover:scale-105 transition-transform duration-500" /></div>
      </div>

      {/* Image Break */}
      <div className="w-full overflow-hidden aspect-[4/3] md:aspect-[16/9] bg-muted"><Image src="cat-47" width={1200} height={900} alt="CAT and Genny training" sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" className="w-full h-full object-contain" /></div>

      {/* Why on-site */}
      <section className="bg-muted/30 py-14">
        <div className="container mx-auto px-6 md:px-8 max-w-5xl">
          <p className="eyebrow text-primary mb-3">On-Site Delivery</p>
          <h2 className="text-2xl md:text-3xl font-black mb-8 text-foreground">Why Scottish Teams Choose On-Site Training</h2>
          <div className="space-y-4 text-muted-foreground leading-relaxed max-w-3xl">
            <p>Scotland has significant infrastructure development across energy, manufacturing and construction sectors. On-site training means your teams learn cable avoidance in the environment they actually work in.</p>
            <p>Sygma delivers at client premises across Scotland including Edinburgh, Glasgow, the Central Belt and throughout the country. Available for full day or half day training sessions to fit your schedule.</p>
          </div>
        </div>
      </section>

      {/* Image Break */}
      <div className="w-full overflow-hidden aspect-[4/3] md:aspect-[16/9] bg-muted"><Image src="cat-67" width={1200} height={900} alt="Utility avoidance training site conditions" sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" className="w-full h-full object-contain" /></div>

      {/* CITB Funding */}
      <section className="container mx-auto px-6 md:px-8 py-14 max-w-5xl">
        <p className="eyebrow text-primary mb-3">Funding</p>
        <h2 className="text-2xl md:text-3xl font-black mb-6 text-foreground">CITB Funding for Cable Avoidance Training in Scotland</h2>
        <div className="space-y-4 text-muted-foreground leading-relaxed max-w-3xl">
      ...
      <section className="bg-primary border-y border-border py-14">
        <div className="container mx-auto px-6 text-center">
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            <Link href="/contact" className="inline-flex items-center px-6 py-3 rounded-md bg-primary-foreground text-primary font-bold text-sm hover:bg-primary-foreground/90 transition-colors">Get a Scotland CAT and Genny Training Quote</Link>
