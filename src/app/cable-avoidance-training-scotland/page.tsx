...
export const metadata: Metadata = {
  ...
  description: 'Cable avoidance and utility location training delivered at your site across Scotland. CAT and Genny training, EUSR CAT1, ProQual qualifications.',
