...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: 'https://res.cloudinary.com/dqf1mp7en/image/upload/f_auto,q_auto,w_1200,h_630,c_fill/CAT4-and-Genny-62', width: 1200, height: 630 }],
    type: 'website',
  },
};
      ...
      <section className="py-10 bg-muted/30">
        <div className="container mx-auto px-6 md:px-8 max-w-5xl">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <Image src="CAT4-and-Genny-49" width={600} height={800} alt="Delegate using CAT equipment during practical assessment" className="w-full rounded-lg object-cover aspect-[3/4]" sizes="(max-width: 768px) 100vw, 33vw" />
            <Image src="CAT4-and-Genny-55" width={600} height={800} alt="Trainer demonstrating signal generator techniques" className="w-full rounded-lg object-cover aspect-[3/4]" sizes="(max-width: 768px) 100vw, 33vw" />
            <Image src="Utility-Mapping-04" width={600} height={800} alt="Utility mapping survey equipment in use on site" className="w-full rounded-lg object-cover aspect-[3/4]" sizes="(max-width: 768px) 100vw, 33vw" />
          </div>
        </div>
      </section>
