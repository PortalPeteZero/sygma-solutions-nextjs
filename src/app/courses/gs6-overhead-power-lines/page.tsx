...
<InnerPageHero
      ...
      <div className="w-full overflow-hidden aspect-[21/9] bg-muted">
        <Image src="cat-95" width={1200} height={900} alt="GS6 overhead power lines training - live training environment" sizes="100vw" className="w-full h-full object-contain" />
      </div>
