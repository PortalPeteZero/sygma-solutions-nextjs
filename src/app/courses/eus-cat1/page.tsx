...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://sygma-solutions.com/courses/eus-cat1',
  },
};
    ...
    <main>
      ...
      <div className="grid grid-cols-3 gap-3 h-52 md:h-64">
        <div className="overflow-hidden rounded-lg">
          <img loading="lazy" src="/images/courses/CAT4-and-Genny-07.webp" alt="EUSR CAT1 practical training with cable locator" className="w-full h-full object-cover hover:scale-105 transition-transform duration-500" />
        </div>
        <div className="overflow-hidden rounded-lg">
          <img loading="lazy" src="/images/courses/CAT4-and-Genny-43.webp" alt="Genny signal generator connection during EUSR CAT1 assessment" className="w-full h-full object-cover hover:scale-105 transition-transform duration-500" />
        </div>
        <div className="overflow-hidden rounded-lg">
          <img loading="lazy" src="/images/courses/CAT4-and-Genny-50.webp" alt="On-site utility detection training for EUSR registration" className="w-full h-full object-cover hover:scale-105 transition-transform duration-500" />
        </div>
      </div>
          ...
          <table className="w-full text-sm border-collapse">
            ...
            <tbody>
              {[
                ...
                <tr key={session as string} className="border-b border-border">
      ...
      <div className="grid grid-cols-3 gap-3 h-52 md:h-64">
        <div className="overflow-hidden rounded-lg">
          <img loading="lazy" src="/images/courses/CAT4-and-Genny-59.webp" alt="Cable avoidance practical assessment on site" className="w-full h-full object-cover hover:scale-105 transition-transform duration-500" />
        </div>
        <div className="overflow-hidden rounded-lg">
          <img loading="lazy" src="/images/courses/CAT4-and-Genny-64.webp" alt="EUSR CAT1 delegates using locator equipment" className="w-full h-full object-cover hover:scale-105 transition-transform duration-500" />
        </div>
        <div className="overflow-hidden rounded-lg">
          <img loading="lazy" src="/images/courses/CAT4-and-Genny-68.webp" alt="Sygma EUSR CAT1 hands-on training session" className="w-full h-full object-cover hover:scale-105 transition-transform duration-500" />
        </div>
      </div>
