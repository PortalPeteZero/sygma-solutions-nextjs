    ...
    <>
      ...
      <section className="container mx-auto px-6 md:px-8 pb-6 max-w-4xl">
        <div className="grid grid-cols-3 gap-3">
          <Image src="MALA-GPR-05" width={800} height={600} alt="Online Level 3 Diploma - practical session" sizes="(max-width: 768px) 100vw, 33vw" className="rounded-lg object-cover aspect-[4/3] w-full" />
          <Image src="Advanced-EM-07" width={800} height={600} alt="Online Level 3 Diploma - hands-on assessment" sizes="(max-width: 768px) 100vw, 33vw" className="rounded-lg object-cover aspect-[4/3] w-full" />
      ...
      <div className="grid grid-cols-3 gap-3 h-52 md:h-64">
        ...
        <div className="overflow-hidden rounded-lg">
          <Image src="MALA-GPR-30" width={1200} height={800} alt="Utility avoidance qualification practical element" sizes="100vw" className="w-full h-full object-cover hover:scale-105 transition-transform duration-500" />
        </div>
        <div className="overflow-hidden rounded-lg">
      ...
      <div className="grid grid-cols-3 gap-3 h-52 md:h-64">
        <div className="overflow-hidden rounded-lg">
          <Image src="MALA-GPR-31" width={1200} height={800} alt="Level 3 Diploma training equipment" sizes="100vw" className="w-full h-full object-cover hover:scale-105 transition-transform duration-500" />
        </div>
        <div className="overflow-hidden rounded-lg">
        ...
        <div className="overflow-hidden rounded-lg">
          <Image src="Advanced-EM-06" width={1200} height={800} alt="Utility avoidance qualification demonstration" sizes="100vw" className="w-full h-full object-cover hover:scale-105 transition-transform duration-500" />
        </div>
      </div>
