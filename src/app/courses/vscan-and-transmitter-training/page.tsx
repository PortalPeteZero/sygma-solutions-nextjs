...
<InnerPageHero
        ...
        <div className="container mx-auto px-6 md:px-8 max-w-5xl">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="bg-white/5 rounded-xl border border-accent/30 p-5 text-center">
              ...
              <p className="text-xs font-bold text-white uppercase tracking-wider mb-1">Increase in Transmitter Usage</p>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-start">
          ...
          <div className="bg-muted/30 rounded-xl border border-border p-6">
            ...
            {[
              ...
              ["Equipment", "Each operative should use their own site equipment. Sygma provide Vivax-Metrotech vScan and transmitter as backup. Any manufacturer's locator and signal generator is suitable."],
      ...
      <section className="container mx-auto px-6 md:px-8 pb-12 max-w-5xl">
        <div className="grid grid-cols-3 gap-4">
          <div className="aspect-[4/3] bg-muted rounded-lg overflow-hidden">
            <Image src="cat-74-vscan-and-transmitter-training" width={1200} height={900} alt="vScan & Tx training outdoors with Sygma" sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" className="w-full h-full object-contain rounded-lg" />
          </div>
          <div className="aspect-[4/3] bg-muted rounded-lg overflow-hidden">
            <Image src="cat-11-vscan-and-transmitter-training" width={1200} height={900} alt="Delegates using locating equipment on site" sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" className="w-full h-full object-contain rounded-lg" />
          </div>
          <div className="aspect-[4/3] bg-muted rounded-lg overflow-hidden">
            <Image src="cat-70-vscan-and-transmitter-training" width={1200} height={900} alt="Practical utility location and excavation training" sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" className="w-full h-full object-contain rounded-lg" />
          </div>
        </div>
      </section>
      ...
      <div className="w-full overflow-hidden  bg-muted" style={{ aspectRatio: "1600 / 733" }}>
        <Image src="cat-57" width={1600} height={733} alt="vScan & Tx training on a live utility site" sizes="100vw" className="w-full h-full object-cover" />
      </div>
            ...
            {[
              {
                ...
                desc: "Confirmation of completion of Sygma vScan & Tx training"
              },
              {
              ...
              },
              {
                ...
                desc: "Practical experience with transmitter and vScan locator in real conditions"
              },
              {
      ...
      <div className="grid grid-cols-3 gap-3">
        <div className="overflow-hidden rounded-lg aspect-[4/3] bg-muted">
          <Image src="cat-66-vscan-and-transmitter-training" width={1200} height={900} alt="Transmitter practical training" sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" className="w-full h-full object-contain hover:scale-105 transition-transform duration-500" />
        </div>
        <div className="overflow-hidden rounded-lg aspect-[4/3] bg-muted">
          <Image src="cat-14-vscan-and-transmitter-training" width={1200} height={900} alt="vScan & Tx training assessment on buried services" sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" className="w-full h-full object-contain hover:scale-105 transition-transform duration-500" />
        </div>
        <div className="overflow-hidden rounded-lg aspect-[4/3] bg-muted">
          <Image src="cat-77-vscan-and-transmitter-training" width={1200} height={900} alt="Hands-on transmitter signal application demonstration" sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" className="w-full h-full object-contain hover:scale-105 transition-transform duration-500" />
        </div>
      </div>
            ...
            <div>
              ...
              <div className="space-y-3">
                {[
                  ...
                  ["Equipment", "Each operative should use the equipment they work with on site. Sygma provide Vivax-Metrotech vScan and transmitter as backup. Any manufacturer's equipment is suitable."],
      ...
      <div className="grid grid-cols-3 gap-3">
        <div className="overflow-hidden rounded-lg aspect-[4/3] bg-muted">
          <Image src="cat-09-vscan-and-transmitter-training" width={1200} height={900} alt="vScan locator training practical session" sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" className="w-full h-full object-contain hover:scale-105 transition-transform duration-500" />
        </div>
        <div className="overflow-hidden rounded-lg aspect-[4/3] bg-muted">
          <Image src="cat-90-vscan-and-transmitter-training" width={1200} height={900} alt="Delegates practising utility location techniques" sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" className="w-full h-full object-contain hover:scale-105 transition-transform duration-500" />
        </div>
        <div className="overflow-hidden rounded-lg aspect-[4/3] bg-muted">
          <Image src="cat-69-vscan-and-transmitter-training" width={1200} height={900} alt="On-site vScan & Tx training assessment" sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" className="w-full h-full object-contain hover:scale-105 transition-transform duration-500" />
        </div>
      </div>
      ...
      <section className="py-16 bg-background">
        <div className="container mx-auto px-4 max-w-5xl">
          ...
          <p className="text-muted-foreground mb-8 max-w-2xl">The course addresses all key elements of <Link href="/courses/hsg47-training">HSG47 guidance</Link> on preventing strikes on underground services.</p>
          <div className="grid md:grid-cols-2 gap-5">
            ...
            <div className="border border-border rounded-lg bg-card p-5">
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">Training in all four locating modes (Power, Radio, Tx and Avoidance) with emphasis on correct operation and limitations.</p>
            </div>
            <div className="border border-border rounded-lg bg-card p-5">
      ...
      {/* Why Sygma for vScan & Tx Training */}
      <section className="py-16 bg-muted/30">
        <div className="container mx-auto px-4 max-w-5xl">
          <p className="text-xs font-semibold tracking-wide text-accent uppercase mb-2">Why Choose Sygma</p>
          <h2 className="text-2xl md:text-3xl font-bold text-foreground mb-4">Why Sygma for vScan & Tx Training</h2>
          ...
          <div className="grid md:grid-cols-2 gap-5">
            ...
            <div className="border border-border rounded-lg bg-card p-5">
              ...
              <h3 className="text-base font-bold text-foreground mb-2">Transmitter-First Methodology</h3>
              <p className="text-sm text-muted-foreground leading-relaxed">70-80% increase in transmitter usage among Sygma-trained operatives. Measured through locator data downloads.</p>
            </div>
            <div className="border border-border rounded-lg bg-card p-5">
      ...
      <section className="py-16 bg-muted/20">
        <div className="container mx-auto px-4 max-w-5xl">
          ...
          <div className="grid md:grid-cols-3 gap-5">
            ...
            <div className="border border-border rounded-lg bg-card p-5">
              <p className="text-xs font-semibold tracking-wide text-accent uppercase mb-2">Foundation</p>
              <h3 className="text-base font-bold text-foreground mb-2">CAT and Genny Training</h3>
              <p className="text-sm text-muted-foreground leading-relaxed mb-4">The Radiodetection CAT4 and Genny4 equivalent of this course, using the same Sygma methodology.</p>
              <Link href="/courses/cat-and-genny-training" className="text-xs font-semibold text-primary hover:text-primary/80 transition-colors">
                View Course &rarr;
              </Link>
            </div>
          </div>
      ...
      <section className="bg-primary/5 border-y border-border py-14">
        <div className="container mx-auto px-6 text-center">
          <h2 className="text-2xl font-black mb-4 text-foreground">Arrange Your vScan & Tx Course</h2>
          <p className="text-muted-foreground mb-8 max-w-xl mx-auto">
            Delivered at your site, nationwide. Bespoke to your equipment, your plans and your risk profile. Contact us for a tailored quote.
          </p>
