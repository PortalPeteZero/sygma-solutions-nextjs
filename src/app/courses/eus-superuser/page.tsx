  ...
  return (
    <>
      ...
      <InnerPageHero
        ...
        image="/images/courses/CAT4-and-Genny-66.webp"
      ...
      <section className="container mx-auto px-6 md:px-8 pb-6 max-w-4xl">
        <div className="grid grid-cols-3 gap-3">
          <img loading="lazy" src="/images/courses/CAT4-and-Genny-40.webp" alt="EUS super user cat and genny training - practical session locating underground services" className="rounded-lg object-cover aspect-[4/3] w-full" />
          <img loading="lazy" src="/images/courses/CAT4-and-Genny-54.webp" alt="Cat and genny training course - hands-on assessment with cable avoidance tools" className="rounded-lg object-cover aspect-[4/3] w-full" />
          <img loading="lazy" src="/images/courses/CAT4-and-Genny-71.webp" alt="Signal generator (genny) application technique - direct connection for locating buried utilities" className="rounded-lg object-cover aspect-[4/3] w-full" />
        </div>
      </section>
      {/* About */}
      ...
      <div className="grid grid-cols-3 gap-3 h-52 md:h-64">
        <div className="overflow-hidden rounded-lg">
          <img loading="lazy" src="/images/courses/CAT4-and-Genny-48.webp" alt="EUS Superuser advanced cable avoidance training" className="w-full h-full object-cover hover:scale-105 transition-transform duration-500" />
        </div>
        <div className="overflow-hidden rounded-lg">
          <img loading="lazy" src="/images/courses/CAT4-and-Genny-01.webp" alt="Advanced electromagnetic locator operation" className="w-full h-full object-cover hover:scale-105 transition-transform duration-500" />
        </div>
        <div className="overflow-hidden rounded-lg">
          <img loading="lazy" src="/images/courses/CAT4-and-Genny-56.webp" alt="Superuser practical assessment on site" className="w-full h-full object-cover hover:scale-105 transition-transform duration-500" />
        </div>
      </div>
      ...
      <div className="w-full h-80 md:h-[400px] overflow-hidden">
        <img loading="lazy" src="/images/courses/CAT4-and-Genny-04.webp" alt="EUS Superuser advanced training delivery on site" className="w-full h-full object-cover object-center" />
      </div>
      ...
      <div className="grid grid-cols-3 gap-3 h-52 md:h-64">
        <div className="overflow-hidden rounded-lg">
          <img loading="lazy" src="/images/courses/CAT4-and-Genny-48.webp" alt="Cable avoidance superuser training" className="w-full h-full object-cover hover:scale-105 transition-transform duration-500" />
        </div>
        <div className="overflow-hidden rounded-lg">
          <img loading="lazy" src="/images/courses/Advanced-EM-08.webp" alt="Advanced locator techniques training" className="w-full h-full object-cover hover:scale-105 transition-transform duration-500" />
        </div>
        <div className="overflow-hidden rounded-lg">
          <img loading="lazy" src="/images/courses/CAT4-and-Genny-56.webp" alt="EUS Superuser practical skills assessment" className="w-full h-full object-cover hover:scale-105 transition-transform duration-500" />
        </div>
      </div>
