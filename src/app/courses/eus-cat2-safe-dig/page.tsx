    ...
    <>
      ...
      <section className="container mx-auto px-6 md:px-8 pb-10 max-w-5xl">
        <div className="grid grid-cols-3 gap-3">
          <Image src="dig-03" width={1200} height={900} alt="Safe dig training in progress" sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" className="w-full rounded-lg object-cover object-top aspect-[4/3]" />
          <Image src="dig-05" width={1200} height={900} alt="On-site practical dig" sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" className="w-full rounded-lg object-cover object-top aspect-[4/3]" />
          <Image src="dig-07" width={1200} height={900} alt="Service exposure technique" sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" className="w-full rounded-lg object-cover object-top aspect-[4/3]" />
        </div>
      </section>
      ...
      <div className="w-full h-56 md:h-80 overflow-hidden">
        <Image src="dig-08" width={1200} height={900} alt="EUSR CAT2 Safe Dig live excavation" sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" className="h-full w-full object-cover object-top" />
      </div>
