...
export default function Level4Diploma() {
  return (
    <>
      ...
      <div className="grid grid-cols-3 gap-3 h-52 md:h-64">
        <div className="overflow-hidden rounded-lg">
          <Image src="Utility-Mapping-02" width={1200} height={800} alt="Level 4 Diploma utility location training" sizes="100vw" className="w-full h-full object-cover hover:scale-105 transition-transform duration-500" />
        </div>
        <div className="overflow-hidden rounded-lg">
