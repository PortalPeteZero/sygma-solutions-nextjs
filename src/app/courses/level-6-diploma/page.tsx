  ...
  return (
    <>
      ...
      <section className="container mx-auto px-6 md:px-8 pb-6 max-w-4xl">
        <div className="grid grid-cols-3 gap-3">
          <div className="aspect-[4/3] bg-muted rounded-lg overflow-hidden">
            <Image src="gpr-02" alt="Level 6 Diploma utility mapping - practical session" width={800} height={600} className="rounded-lg w-full h-full object-contain" sizes="(max-width: 768px) 100vw, 33vw" />
          </div>
          <div className="aspect-[4/3] bg-muted rounded-lg overflow-hidden">
            <Image src="gpr-07" alt="Level 6 Diploma utility mapping - hands-on assessment" width={800} height={600} className="rounded-lg w-full h-full object-contain" sizes="(max-width: 768px) 100vw, 33vw" />
          </div>
          <div className="aspect-[4/3] bg-muted rounded-lg overflow-hidden">
            <Image src="gpr-05" alt="Level 6 Diploma utility mapping - on-site delivery" width={800} height={600} className="rounded-lg w-full h-full object-contain" sizes="(max-width: 768px) 100vw, 33vw" />
          </div>
        </div>
      </section>
      ...
      <div className="w-full overflow-hidden aspect-[4/3] md:aspect-[16/9] bg-muted">
        <Image src="gpr-12" alt="Level 6 Diploma utility mapping - advanced electromagnetic survey training" width={1200} height={900} className="w-full h-full object-contain" sizes="100vw" />
      </div>
      ...
      <div className="grid grid-cols-3 gap-3">
        <div className="overflow-hidden rounded-lg aspect-[4/3] bg-muted">
          <Image src="gpr-04" alt="Level 6 Diploma advanced training session" width={800} height={600} className="w-full h-full object-contain hover:scale-105 transition-transform duration-500" sizes="(max-width: 768px) 100vw, 33vw" />
        </div>
        <div className="overflow-hidden rounded-lg aspect-[4/3] bg-muted">
        ...
        <div className="overflow-hidden rounded-lg aspect-[4/3] bg-muted">
          <Image src="gpr-11" alt="Advanced electromagnetic detection training" width={800} height={600} className="w-full h-full object-contain hover:scale-105 transition-transform duration-500" sizes="(max-width: 768px) 100vw, 33vw" />
        </div>
      </div>
      ...
      <div className="grid grid-cols-3 gap-3">
        <div className="overflow-hidden rounded-lg aspect-[4/3] bg-muted">
          <Image src="em-03" alt="Level 6 Diploma utility management training" width={800} height={600} className="w-full h-full object-contain hover:scale-105 transition-transform duration-500" sizes="(max-width: 768px) 100vw, 33vw" />
        </div>
        <div className="overflow-hidden rounded-lg aspect-[4/3] bg-muted">
          <Image src="em-02" alt="GPR data interpretation for Level 6" width={800} height={600} className="w-full h-full object-contain hover:scale-105 transition-transform duration-500" sizes="(max-width: 768px) 100vw, 33vw" />
        </div>
        <div className="overflow-hidden rounded-lg aspect-[4/3] bg-muted">
          <Image src="em-07" alt="Advanced qualification practical assessment" width={800} height={600} className="w-full h-full object-contain hover:scale-105 transition-transform duration-500" sizes="(max-width: 768px) 100vw, 33vw" />
        </div>
      </div>
