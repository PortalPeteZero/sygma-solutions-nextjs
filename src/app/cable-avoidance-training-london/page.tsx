...
export const metadata: Metadata = {
  title: 'Cable Avoidance Training London | Utility Mapping',
  description: 'Professional cable avoidance training in London. Learn to identify and avoid underground utilities safely.',
  keywords: 'cable avoidance, London, utility training, underground cables, safe digging',
  openGraph: {
    title: 'Cable Avoidance Training London',
    description: 'Professional cable avoidance training in London',
    type: 'website',
  },
};
...
export default function CableAvoidanceTrainingLondon() {
  return (
    <main>
      <script
        type="application/ld+json"
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(faqPageSchema(faqs, 'Cable Avoidance Training London')),
        }}
      />
      <script
        type="application/ld+json"
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(
            breadcrumbSchema([
              ...
              { name: 'Cable Avoidance Training London', url: '/cable-avoidance-training-london' },
            ])
          ),
        }}
      />
      ...
      <div className="hero-section">
        <h1>Cable Avoidance Training in London</h1>
      ...
      <section className="image-strip">
        <Image
          src="/images/london-training-1.jpg"
