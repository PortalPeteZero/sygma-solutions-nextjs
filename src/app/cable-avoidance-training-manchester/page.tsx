...
export default function CableAvoidanceManchester() {
  ...
  return (
    <>
      ...
      {/* Image Break */}
      <div className="w-full overflow-hidden"><Image src="cat-39" width={1200} height={900} alt="CAT and Genny training" sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" className="w-full h-full object-contain" /></div>
      ...
      {/* Image Break */}
      <div className="w-full overflow-hidden"><Image src="cat-41" width={1200} height={900} alt="Utility avoidance training site conditions" sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" className="w-full h-full object-contain" /></div>
