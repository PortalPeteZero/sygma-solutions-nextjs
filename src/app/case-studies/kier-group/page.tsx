  ...
  return (
    <>
      ...
      <div className="w-full h-80 md:h-[400px] overflow-hidden">
        <Image src="Safe-Dig-01" width={1200} height={800} alt="Kier Group safe digging training operations" sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" className="h-full w-full object-cover object-top" />
      </div>
      ...
      <section className="py-12 bg-background">
        <div className="container mx-auto px-6 md:px-8 max-w-5xl">
          <div className="grid md:grid-cols-3 gap-4">
            <Image src="CAT4-and-Genny-01" width={1200} height={800} alt="Kier Group CAT and Genny training with operatives" sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" className="w-full rounded-lg object-cover object-top aspect-[4/3]" />
            <Image src="CAT4-and-Genny-02" width={1200} height={800} alt="Kier Group delegates practising CAT and Genny equipment operation" sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" className="w-full rounded-lg object-cover object-top aspect-[4/3]" />
            <Image src="Safe-Dig-02" width={1200} height={800} alt="Kier Group safe digging practical assessment session" sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" className="w-full rounded-lg object-cover object-top aspect-[4/3]" />
          </div>
        </div>
      </section>
      ...
      <div className="grid grid-cols-3 gap-3 h-72 md:h-96">
        <div className="overflow-hidden rounded-lg">
          <Image src="CAT4-and-Genny-50" width={1200} height={800} alt="Kier Group utility avoidance field training" sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" className="h-full w-full object-cover object-top hover:scale-105 transition-transform duration-500" />
        </div>
        <div className="overflow-hidden rounded-lg">
          <Image src="Safe-Dig-11" width={1200} height={800} alt="Practical safe digging assessment" sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" className="h-full w-full object-cover object-top hover:scale-105 transition-transform duration-500" />
        </div>
        <div className="overflow-hidden rounded-lg">
          <Image src="CAT4-and-Genny-40" width={1200} height={800} alt="Cable detection equipment in bespoke training" sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" className="h-full w-full object-cover object-top hover:scale-105 transition-transform duration-500" />
        </div>
      </div>
