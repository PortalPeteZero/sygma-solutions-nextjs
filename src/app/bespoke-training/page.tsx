  ...
  return (
    <>
      <section className="relative overflow-hidden min-h-[400px] md:min-h-[480px] bg-foreground">
        <Image src="https://res.cloudinary.com/sygma-solutions/image/upload/CAT4-and-Genny-61" fill className="absolute inset-0 h-full w-full object-cover" priority sizes="100vw" alt="Bespoke training hero" />
