    ...
    <div className="min-h-screen bg-white">
      <section className="bg-gradient-to-r from-blue-600 to-blue-800 text-white py-16">
        <div className="max-w-7xl mx-auto px-4">
          <h1 className="text-5xl font-bold mb-4">Programmes Built Around Your Sites, Your Risks, and Your People.</h1>
          <p className="text-xl mb-8">Off-the-shelf training solves generic problems. Bespoke training solves yours. If you have a specific incident history, a specific permit system, or a workforce that needs more than a standard course can give them, we design the programme from the ground up.</p>
        </div>
      </section>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-5xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-5">
            {whatWeDesign.map((w) => (
              <div key={w.title} className="border border-gray-300 rounded-lg bg-white p-5">
      ...
      <section className="py-16">
        <div className="max-w-5xl mx-auto px-4">
          ...
          <p className="text-gray-600 leading-relaxed mb-6">Bespoke programmes are delivered at your site. Your team trains in the environment they actually work in, using the equipment they use on the job, against the site risks they face every day.</p>
          <div className="grid sm:grid-cols-2 gap-5">
            {[
              ...
              <div key={item.title} className="rounded-lg border border-gray-300 bg-gray-50 p-5">
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-5xl mx-auto px-4">
          ...
          <div className="space-y-4">
            {process.map((p) => (
              <div key={p.step} className="flex gap-4 border border-gray-300 rounded-lg bg-white p-5">
                <div className="shrink-0 w-9 h-9 bg-blue-600 rounded-full flex items-center justify-center text-white font-bold">{p.step}</div>
                <div>
        ...
        <div className="max-w-5xl mx-auto px-4">
          ...
          <div className="space-y-4">
            {[
              ...
              <div key={c.name} className="border border-gray-300 rounded-lg bg-white p-5">
