...
export default function Contact() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      alert('Something went wrong. Please try again or call us on 0203 971 8252.');
    } finally {
      setSubmitting(false);
    }
  };
            ...
            <div className="lg:col-span-1 space-y-6">
              <div>
                ...
                <ul className="space-y-4">
                  <li>
                    <a href="tel:+442039718252" className="flex items-start gap-3 group">
                  ...
                  <li>
                    <a href="mailto:enquiries@sygma-solutions.com" className="flex items-start gap-3 group">
